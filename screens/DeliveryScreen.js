...
const restaurant = useSelector(selectRestaurant)
  ...
  return (
    <View className="bg-[#00CCBB] flex-1">
      <SafeAreaView className="pt-5 z-50">
        ...
        <View className="bg-white mx-5 rounded-md p-6 z-50 shadow-md">
            ...
            <Progress.Bar size={20} indeterminate={true} borderColor='#00CCBB' color='#00CCBB'/>
        ...
        <SafeAreaView className="bg-white flex-row items-center space-x-5 h-28">
            <Image 
                ...
                //source={require("../assets/Yhoung Brown (Transparent).png")}
                className="h-12 w-12 rounded-full bg-gray-300 p-4 ml-5"
            />

            <View className="flex-1">
                <Text className="text-lg">Omotola Odumosu</Text>
